...
def run_react_agent(user_query: str, provider, mcp_server: MCPMedicalServer) -> list:
    ...
    while step < MAX_ITERATIONS:
        ...
        # Trường hợp 2: LLM đề xuất gọi Tool (Action)
            ...
            current_prompt = (
                f"{user_query}\n\n"
                "KẾT QUẢ OBSERVATION TỪ MCP SERVER:\n"
                f"{json.dumps(obs_data, ensure_ascii=False)}\n\n"
                "Hãy tổng hợp câu trả lời cuối cùng dựa trên observation này. "
                "Không gọi lại tool nếu đã đủ dữ liệu."
            )
...
if __name__ == "__main__":
    ...
    if "--interactive" in sys.argv:
        ...
        print("   - Tra cứu lịch: 'Tra cứu lịch bác sĩ Nguyễn Minh Anh chuyên khoa Tim mạch tại Vinmec'")
        print("   - Đặt lịch khám: 'Đặt lịch khám Tim mạch với bác sĩ Nguyễn Minh Anh lúc 09:00 ngày 20/09/2026'")
